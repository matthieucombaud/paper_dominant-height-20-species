fit_data_final_2 <- function(
  ...
  # param value and sde and p-value (but attention, not linear model...)
    ...
    hessian <- f$he(f$env$last.par.best)
    # if(!isSymmetric(hessian)){stop("Hessian not semi-definite positive")}
