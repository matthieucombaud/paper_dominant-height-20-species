old_select.one.level_simpler<-function(db.model.selection,variables.included,variables.to.test,c.start.gnls.general,db.constraint,db.fixed.variables,macrovar,vif.threshold){
